    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                ...
                // Botón "Siguiente"
                NavigationLink(destination: ScreenLogin()) { // Navega a ScreenLogin al finalizar el onboarding
                    Text("Comenzar") // Cambiado el texto del botón
        ...
        .navigationBarBackButtonHidden(true) // Oculta el botón de retroceso por defecto
        .toolbar {
            ToolbarItem(placement: .navigationBarLeading) {
                Button(action: {
                    self.presentationMode.wrappedValue.dismiss() // Acción para ir atrás
                }) {
                        Image(systemName: "chevron.left")
                            .foregroundColor(Color(red: 0.043, green: 0.067, blue: 0.173)) // Color de la flecha
                            .padding(10)
...
#Preview {
    ScreenOnboarding3(
        imageName: "onboarding3", // Usando el logo como placeholder
        title: "Seguimiento a tus reportes",
        description: "Mantente al tanto del estatus de tus reportes",
        currentPage: 2,
        totalPages: 3
    )
}
